...
library(patchwork)
###Set variables###
averages_per_window <- "/Genomic-Organisation-of-MeningococcaL-pilS-in-Carriage-and-Disease/NZ96294/deletions/averages_per_window.txt" #set the path to the averages_per_window.txt file for each isolate this example is for isolate NZ96294
pilS_start <- 625149
pilS_end <- 633833
...
deletions_var_plot_zoomed = ggplot(deletions_windows, aes(x = position, y = sample_variance)) +
  ...
  coord_cartesian(xlim = c(pilS_start - 10000, pilS_end + 10000))  # Zoom in with buffer
