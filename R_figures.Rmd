...
###Set the variables###
pilS_comparison_csv <- "/Genomic-Organisation-of-Meningococcal-pilS-in-Carriage-and-Disease/pilS_comparisons.csv" #set the path to the csv file
...
###Set the variables###
pilS_comparison_csv <- "/Genomic-Organisation-of-Meningococcal-pilS-in-Carriage-and-Disease/pilS_comparisons.csv" #csv file path only needs to be changed if moved
...
###Set the variables###
assembly_stats_csv <- "/Genomic-Organisation-of-Meningococcal-pilS-in-Carriage-and-Disease/assembly_stats.csv" #csv file path only needs to be changed if moved
