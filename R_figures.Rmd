...
Use the csv file "pilS_comparisons.csv containing the length of the pilS region (inlcuding fbp and lpxC without the 1kb buffer) and number of silent cassettes from the consensus annotation 
